...
describe('Main Generator', function () {
  ...
  describe('Application generator without sample module 0.4.0 using options', function () {
    before(function (done) {
      helpers.run(path.join(__dirname, '../app'))
        .withOptions({
          'skip-install': true,
  ...
  describe('Application generator without sample module 0.4.1 using options', function () {
    before(function (done) {
      helpers.run(path.join(__dirname, '../app'))
        .withOptions({
          'skip-install': true,
  ...
  describe('Application generator without sample module 0.4.2 using options', function () {
    before(function (done) {
      helpers.run(path.join(__dirname, '../app'))
        .withOptions({
          'skip-install': true,
